...
struct TaskCard: View {
    ...
    var body: some View {
        //add some change -- NOTHING NEEDS TO BE CHANGED REALLY
        ZStack{ //Stacks all text, buttons, and other details; starting from bottom to topPP
            ...
            Text("\(task.category.name)") //Name of category assigned to task
                ...
                .frame(minWidth: 0, idealWidth: 100, maxWidth: 147, minHeight: 1, idealHeight: 1, maxHeight: 1, alignment: .init(horizontal: .leading, vertical: .center))
                .padding(.leading, 158.0)
                .padding(.top, -5)
